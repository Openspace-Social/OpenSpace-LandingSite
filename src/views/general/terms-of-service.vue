        ...
        <div class="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
          <div class="pt-32 sm:pt-0">
            ...
            <p class="mt-4 text-lg leading-relaxed text-blueGray-500">
                Terms of Service (ToS), also known as Terms and Conditions or Terms of Use, are a set of rules and guidelines that users must agree to and abide by when using a particular service or website. These terms outline the rights and responsibilities of both the user and the provider of the service.
            </p>
          </div>
        </div>
      </div>
...
import patternVue from "@/assets/img/patterns/Thur.png";
