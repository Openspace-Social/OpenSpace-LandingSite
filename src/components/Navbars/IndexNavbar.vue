<template>
  ...
  >
    ...
    >
      ...
      >
        <router-link to="/" href="#pablo">
          <a
            class="text-emerald-600 text-2xl font-bold leading-relaxed inline-block py-2 whitespace-nowrap"
          >
            O <i class="text-blueGray-700 text-base font-normal not-italic"> | Openspace.social</i>
        ...
        <ul class="flex flex-col lg:flex-row list-none lg:ml-auto">
          ...
          <li class="flex items-center">
            <a
              ...
              href="https://www.linkedin.com/company/openspacesocial/"
              target="_blank"
            >
          ...
          <li class="flex items-center">
            <a
              class="hover:text-blueGray-500 text-blueGray-700 px-3 py-2 flex items-center text-xs uppercase font-bold"
              href="https://www.instagram.com/openspace.social"
              target="_blank"
            >
...
<a href="https://web.openspace.social">
          <li class="flex items-center">
            <button
              ...
              type="button"
            >
              <i class="fas fa-user lg:mr-2"></i> Login
            </button>
          </li>
</a>
<a href="https://web.openspace.social/a/request-invite">
          <li class="flex items-center">
            <button
              ...
              type="button"
            >
              <i class="fas fa-user lg:mr-2"></i> Sign-Up
            </button>
          </li>
</a>
